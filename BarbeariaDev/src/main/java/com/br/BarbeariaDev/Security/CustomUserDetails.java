...
public class CustomUserDetails implements UserDetails, CredentialsContainer {
	...
	public CustomUserDetails(Barbeiro barbeiro, String username, String password,
			Collection<? extends GrantedAuthority> authorities) {
		this(barbeiro, username, password, true, true, true, true, authorities);
	}

	public CustomUserDetails(Barbeiro barbeiro, String username, String password, boolean enabled,
	...
	public static class UserBuilder {
		...
		public UserDetails build() {
			...
			return new CustomUserDetails(barbeiro, username, encodedPassword, !disabled, !accountExpired,
